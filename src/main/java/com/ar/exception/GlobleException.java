...
public class GlobleException {
	...
	public ResponseEntity<ErrorDetail> MessageExceptionHandler(ChatException ue, WebRequest req)
	{
		ErrorDetail err=new ErrorDetail(ue.getMessage(),req.getDescription(false),LocalDateTime.now());
		return new ResponseEntity<ErrorDetail>(err,HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorDetail> handleNoHandlerFoundEception(NoHandlerFoundException ne,WebRequest req)
	{
